...
export default function Card({ course, content = "true" }) {
  return (
    <div className="w-[400px] h-[560px] bg-white rounded-xl shadow-2xl">
      {content && (
        <>
          ...
          <div className="w-full px-8 mt-4 flex-row justify-center">
            ...
            <h2 className="mt-4 font-medium text-xl line-clamp-3">
              {course.title}
            </h2>
