      ...
      <div className="xl:p-20 lg:p-10 md:p-14 sm:p-8 p-8 w-full">
        <div className="mt-16 gap-8 w-full flex">
          <div className="flex flex-col w-1/2">
            ...
            <h1 className="text-4xl font-semibold mt-32">
              Platform{' '}
              <GradientText
            ...
            <p className="text-3xl font-extralight mt-16">
              Jelajahi course terbaik dengan materi berkualitas dan instruktur profesional
            </p>
            <Button variant="primary" className="text-lg mt-16 w-fit px-8" to="/course">
              Jelajahi Course
            </Button>
          </div>
          <div className="relative flex w-1/2 lg:mt-[-2.5rem] justify-center items-start">
            <StackedCards course={course} count={3} />
          </div>
        </div>
      </div>
      <div className="mt-32 w-scren bg-white-100">
        <div className="xl:p-20">
          <h2 className="text-4xl font-semibold">Kategori Populer</h2>
        </div>
      </div>
    </Template>
  );
